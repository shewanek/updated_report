...
def main():
    ...
    try:
        if uploaded_file is not None:
            from dependence import all_branch_code_exist, any_target_date_exists, upload_to_unique
            ...
            try:
                ...
                required_columns = {'branch_code', 'customer_number', 'customer_name', 'saving_account', 'product_type', 'disbursed_amount', 'disbursed_date'}
                ...
                if missing_columns:
                    ...
                    if required_df.isnull().any().any():
                        ...
                        try:
                            ...
                            invalid_dates = df['disbursed_date'].isna()
                            if invalid_dates.any():
                                st.error("The disbursed_date column contains invalid dates.")
                                return
