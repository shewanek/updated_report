...
from dependence import connect_to_database, load_salesuniquedata
...
def main():
    ...
    if mydb is not None:
        cursor = mydb.cursor()
        unique_cust_by_branch, unique_cust_by_self, registed_by_branch, df_combine = load_salesuniquedata(mydb)
        # Side bar
