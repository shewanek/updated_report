...
import decimal
import numpy as np
from dependence import load_actual_vs_targetdata, load_kiyya_actual_vs_targetdata, load_actual_vs_targetdata_per_product, load_actual_vs_targetdata_collection
...
def main():
    ...
    if fy_label == "2024/2025":
        ...
        tab_options = ["Disbursement", "Collection"]
        active_tabb = st.radio(
            "Select a Tab",
            options=tab_options,
            index=0,  # default selection (0 = first item)
            horizontal=True,
            help="Choose between Disbursement or Collection mode"
        )
