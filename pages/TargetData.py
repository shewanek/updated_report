...
def main():
    ...
    try:
        if uploaded_file is not None:
            from dependence import all_branch_code_exist, any_targetperpro_date_exists, upload_to_target
            ...
            try:
                ...
                required_columns = {'branch_code', 'product_type', 'unique_target', 'account_target', 'disbursment_target', 'target_date'}
                    ...
                    if required_df.isnull().any().any():
                        ...
                        if missing_branch_code:
                            ...
                            try:
                                ...
                                if any_targetperpro_date_exists(df):
                                    st.error("One or more Target dates in the uploaded file already exist in the database. this means You are trying to upload same data twice. Upload aborted.")
                                else:
                                    
                                    if upload_to_target(df):
