...
def main():
    ...
    html_title = """
        ...
        <center> <h3 class="title_dash"> Michu Closed Data Upload Portal </h3> </center>
        """
    with col2:
    ...
    uploaded_file = st.file_uploader(":orange[Upload Closed Excel file 👇🏻]", type=["csv", "txt", "xlsx", "xls"], accept_multiple_files=False)
    # make_sidebar1()
