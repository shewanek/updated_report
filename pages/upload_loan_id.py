...
def main():
    ...
    html_title = """
        ...
        <center> <h3 class="title_dash"> Michu Merchent Data Upload Portal </h3> </center>
        """
    with col2:
    ...
    uploaded_file = st.file_uploader(":orange[Upload Merchent Excel file 👇🏻]", type=["csv", "txt", "xlsx", "xls"], accept_multiple_files=False)
    # make_sidebar1()

    try:
        if uploaded_file is not None:
            from dependence import  upload_loanid
            ...
            try:
                ...
                required_columns = {'loan_id', 'phone', 'emergene_phone'}
                # st.write(df.columns)
                ...
                if missing_columns:
                    ...
                    df['emergene_phone'] = df['emergene_phone'].str.strip()
                    try:
