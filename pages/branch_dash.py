...
from dependence import load_branchdata, load_customer_detail
...
def main():
    ...
    try:
        dureti_customer, unique_customer, conversion_customer, unique_cust_by_branch, unique_cust_by_self, registed_by_branch = load_branchdata(username)
        df_combine_closed, df_combine_active, df_combine_arrears = load_customer_detail(username)
        # unique_customer
        # conversion_customer
        # Sidebar
