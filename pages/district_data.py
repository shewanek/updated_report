...
def main():
    ...
    if mydb is not None:
        ...
        combined_branches = sorted(set(df_unique["Branch"].dropna().unique()) | set(unique_cust_by_branch["Branch"].dropna().unique()) | set(unique_cust_by_self["Branch"].dropna().unique()) | set(registed_by_branch["Branch"].dropna().unique()) | set(df_combine_closed["Branch"].dropna().unique()) | set(df_combine_active["Branch"].dropna().unique()) | set(df_combine_arrears["Branch"].dropna().unique()))
        ...
        col1.metric(label="**Total Unique**", value=df_unique.uniqueId.nunique(), delta="Customer")
